...
module.exports = function(img, obj, callback){
  ...
  callback(obj)
  console.log("success!") 
  console.log("Type: " + obj['bitmapType']);
  console.log("File size: " + obj['fileSize']);
  console.log("Image offset: " + obj['imgStart']);
  console.log("Header name: " + obj['headerName']);
  console.log("Image width(pix): " + obj['imgWidth']);
  console.log("Image height(pix): " + obj['imgHeight']);
